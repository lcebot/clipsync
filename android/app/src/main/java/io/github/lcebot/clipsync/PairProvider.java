...
final class PairProvider implements Closeable {
     ...
     * derivation is deliberately slow, under a second (see {@link Pairing#channelKey}), plus
    ...
    private Outcome serve(Socket s) {
        ...
        try {
            ...
            // key has already left the device. Blocking here is fine, because callers are served serially,
