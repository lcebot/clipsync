...
android {
    ...
    // it does not — 1.13.0's notes say 35 as well. So this may stay at 35, and 1.14 is not a reason
    // to raise it.
    compileSdk = 35
    ...
    defaultConfig {
        ...
        //
        // It went 35 -> 34 because nothing in the app needed 35: the highest API actually called is
        // the specialUse foreground-service type, which is 34. 35 was excluding most of the devices
        // this app is FOR — Xposed and root users are disproportionately on older ROMs — in exchange
        // for nothing at all. That argument was correct and has not been refuted.
        //
